...
<body class="f-poppins">
    ...
    <nav class="navbar navbar-expand-lg fixed-top py-3" id="navbar">
        <div class="container ">
            <a class="navbar-brand" href="/">
                <svg viewBox="0 0 236.08 204.09" style="height: 2rem" class="me-2 ">
                    <defs>
                        <style>
                ...
                <svg viewBox="0 0 777.96 146.64" style="height: 1.25rem" class="">
                    <defs>
            ...
            <div class="collapse navbar-collapse navbar-mobile-bg" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mt-3 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-body text-center text-uppercase fw-semibold" id="beranda" aria-current="page" href="/">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-body text-center text-uppercase fw-semibold" id="profil" href="/profil">Profil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-body text-center text-uppercase fw-semibold" id="jadwal" href="/jadwal">Jadwal</a>
                    </li>
                    @if(Auth::check())
                    <li class="nav-item">
                        <a class="nav-link text-body text-center text-uppercase fw-semibold" id="reservasi" href="/reservasi">Reservasi</a>
                    </li>
                    @endif
                    <hr class="d-lg-none">
                    ...
                    <div class="dropdown text-light">
                        <button class="nav-link mx-auto btn dropdown-toggle text-body text-uppercase fw-semibold" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <footer class="bg-light">
        <div class="container">
          <div class="text-center text-secondary fw-semibold py-3">
