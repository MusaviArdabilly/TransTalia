    ...
    <style>
        ...
        */
        ...
        @keyframes showText {
            ...
            99% {
                /* --animation-sentence: "You know you're supposed to leave, right?"; */
                --animation-sentence: "Sepertinya anda harus keluar dari sini";
                opacity: 0;
                visibility: hidden;
            }
            100% {
                /* --animation-sentence: "So much to do, so little time..."; */
                --animation-sentence: "Anda hanya akan buang buang waktu disini...";
            }
        }
        @keyframes showNewText {
            ...
            100% {
                ...
                */
                --animation-sentence: "Baiklah sepertinya anda orang yang sabar, ini saya kasih kuncinya untuk membuka halaman ini";
            }
        }
